...
def resolve_log_dir(log_dir: str | Path | None = None) -> Path:
    ...
    Default:
        project_root / experiments / goes16_abi_c13_conus / logs
    """
    if log_dir is None:
        return get_project_root() / "experiments" / "goes16_abi_c13_conus" / "logs"
...
def main(
    ...
    PNG output:
        project_root / experiments / goes16_abi_c13_conus / logs / overview_plots
    """

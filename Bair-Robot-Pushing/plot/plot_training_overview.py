...
def resolve_log_dir(log_dir: str | Path | None = None) -> Path:
    ...
    Default:
        project_root / experiments / bair_robot_pushing_small / logs
    """
    if log_dir is None:
        return get_project_root() / "experiments" / "bair_robot_pushing_small" / "logs"
...
def plot_mse_comparison(
    ...
    plot_two_models(
        ...
        prior_key="train_img_mse",
        gemini_key="train_image_mse",
        prior_label="Image prior train MSE",
        gemini_label="GeminiNet train image MSE",
        title="Image MSE on training set",
        ylabel="Image MSE",
    )
    ...
    plot_two_models(
        ...
        prior_history=image_history,
        gemini_history=gemini_history,
        prior_key="val_img_mse",
        gemini_key="val_image_mse",
        prior_label="Image prior val MSE",
        gemini_label="GeminiNet val image MSE",
        title="Image MSE on validation set",
        ylabel="Image MSE",
    )
    ...
    plot_two_models(
        ...
        gemini_history=gemini_history,
        prior_key="train_num_mse",
        gemini_key="train_num_mse",
        prior_label="Numerical prior train MSE",
        gemini_label="GeminiNet train numerical MSE",
        title="Numerical MSE on training set",
    ...
    plot_two_models(
        ...
        prior_history=num_history,
        gemini_history=gemini_history,
        prior_key="val_num_mse",
        gemini_key="val_num_mse",
        prior_label="Numerical prior val MSE",
        gemini_label="GeminiNet val numerical MSE",
        title="Numerical MSE on validation set",
        ylabel="Numerical MSE",
    )
...
def plot_mae_comparison(
    ...
    plot_two_models(
        ...
        prior_history=image_history,
        gemini_history=gemini_history,
        prior_key="train_img_mae",
        gemini_key="train_image_mae",
        prior_label="Image prior train MAE",
        gemini_label="GeminiNet train image MAE",
        title="Image MAE on training set",
        ylabel="Image MAE",
    )
    ...
    plot_two_models(
        ...
        prior_history=image_history,
        gemini_history=gemini_history,
        prior_key="val_img_mae",
        gemini_key="val_image_mae",
        prior_label="Image prior val MAE",
        gemini_label="GeminiNet val image MAE",
        title="Image MAE on validation set",
        ylabel="Image MAE",
    )
    ...
    plot_two_models(
        ...
        prior_history=num_history,
        gemini_history=gemini_history,
        prior_key="train_num_mae",
        gemini_key="train_num_mae",
        prior_label="Numerical prior train MAE",
        gemini_label="GeminiNet train numerical MAE",
        title="Numerical MAE on training set",
    ...
    plot_two_models(
        ...
        prior_history=num_history,
        gemini_history=gemini_history,
        prior_key="val_num_mae",
        gemini_key="val_num_mae",
        prior_label="Numerical prior val MAE",
        gemini_label="GeminiNet val numerical MAE",
        title="Numerical MAE on validation set",
        ylabel="Numerical MAE",
    )
...
def main(
    ...
    PNG output:
        project_root / experiments / bair_robot_pushing_small / logs / overview_plots
    """

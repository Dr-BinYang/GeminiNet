...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default=r"./datasets/BAIR_Robot_Pushing_Small/processed",
        help="Folder containing converted BAIR .npy arrays and metadata.json.",
    )
    parser.add_argument(
        "--exp_dir",
        type=str,
        default=r"./experiments/bair_robot_pushing_small",
        help="Folder for BAIR logs, checkpoints and visualization results.",
    )
    ...
    parser.add_argument(
        "--img_size", type=int, default=64, help="Height and width of BAIR image frames."
    )
    parser.add_argument(
        "--img_channels", type=int, default=3, help="Number of BAIR RGB image channels."
    )
    parser.add_argument(
        "--num_vars",
        type=int,
        default=5,
        help="BAIR numerical variables used by the model: ee_x, ee_y, ee_z, action_1, action_2.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Fraction of converted BAIR train samples to use.",
    )
    parser.add_argument(
        "--test_usage_ratio",
        type=float,
        default=1,
        help="Fraction of converted BAIR test samples to use. Use 1.0 for final evaluation.",
    )
    ...
    parser.add_argument(
        ...
        help="Image normalization type. BAIR RGB uint8 frames use scale_01.",
    )
    parser.add_argument(
        "--num_norm_type",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Image output activation. Use sigmoid for [0,1] pixels and linear for z-score physical fields.",
    )
    parser.add_argument(
...
def validate_dataset_shapes(args, loaders) -> None:
    ...
    if actual != expected:
        raise ValueError(
            ...
            "python scripts/preprocess_bair_robot_pushing.py "
            "--input_len 15 --pred_len 15 --force"
        )

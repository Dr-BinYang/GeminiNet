...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default=r"./datasets/KTH_Action/processed",
        help="Folder containing processed KTH Action arrays and metadata.",
    )
    parser.add_argument(
        "--exp_dir",
        type=str,
        default=r"./experiments/kth_action_motion_stats",
        help="Folder for KTH Action logs, checkpoints and visualization results.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=15,
        help="Length of historical KTH grayscale-frame observation sequence.",
    )
    parser.add_argument(
        "--input_len_num",
        type=int,
        default=15,
        help="Length of historical KTH motion-statistic observation sequence.",
    )
    parser.add_argument(
        "--pred_len_img",
        type=int,
        default=15,
        help="Length of future KTH grayscale-frame sequence to predict.",
    )
    parser.add_argument(
        "--pred_len_num",
        type=int,
        default=15,
        help="Length of future KTH motion-statistic sequence to predict.",
    )
    parser.add_argument(
        "--img_height", type=int, default=120, help="Height of processed KTH Action frames."
    )
    parser.add_argument(
        "--img_width", type=int, default=120, help="Width of processed KTH Action frames."
    )
    parser.add_argument(
        "--img_channels", type=int, default=1, help="Number of KTH Action grayscale-frame channels."
    )
    parser.add_argument(
        "--num_vars",
        type=int,
        default=8,
        help="KTH numerical variables: video-derived motion-state statistics.",
    )
    parser.add_argument(
        "--window_stride",
        type=int,
        default=5,
        help="Sliding-window stride inside each KTH sequence.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Fraction of processed KTH sequences to use.",
    )
    parser.add_argument(
        "--test_usage_ratio",
        type=float,
        default=1.0,
        help="Fraction of KTH test windows to use. Use 1.0 for final evaluation.",
    )
    ...
    parser.add_argument(
        ...
        help="Image normalization type. scale_01 is recommended for KTH grayscale videos.",
    )
    parser.add_argument(
        "--num_norm_type",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Image output activation. Use sigmoid for scale_01 grayscale videos.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--epochs_gemini", type=int, default=400, help="Number of training epochs for GeminiNet."
    )
    parser.add_argument(
        "--batch_size",
        type=int,
...
def validate_dataset_shapes(args, loaders) -> None:
    ...
    if actual != expected:
        raise ValueError(
            ...
            "python scripts/preprocess_kth_action.py --force"
        )
    ...
    if actual_img_shape != expected_img_shape or actual_img_channels != args.img_channels:
        raise ValueError(
            ...
            f"python scripts/preprocess_kth_action.py --img_height {args.img_height} --img_width {args.img_width} --force"
        )

...
def resolve_log_dir(log_dir: str | Path | None = None) -> Path:
    ...
    Default:
        project_root / experiments / sevir_ir107_192 / logs
    """
    if log_dir is None:
        return get_project_root() / "experiments" / "sevir_ir107_192" / "logs"
...
def main(
    ...
    PNG output:
        project_root / experiments / sevir_ir107_192 / logs / overview_plots
    """

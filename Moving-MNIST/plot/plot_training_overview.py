...
def plot_mse_comparison(
    ...
    plot_two_models(
        ...
        title="Image MSE on respective training partitions",
        ylabel="Image MSE",
    )
    ...
    plot_two_models(
        ...
        title="Numerical MSE on respective training partitions",
...
def plot_mae_comparison(
    ...
    plot_two_models(
        ...
        title="Image MAE on respective training partitions",
        ylabel="Image MAE",
    )
    ...
    plot_two_models(
        ...
        title="Numerical MAE on respective training partitions",

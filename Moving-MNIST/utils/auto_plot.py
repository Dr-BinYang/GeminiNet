...
# Plotting imports Matplotlib after PyTorch has usually been initialized.
# Some Windows Conda stacks load duplicate OpenMP runtimes at that point.
...
def run_auto_plots(args) -> None:
    ...
    exp_dir = Path(getattr(args, "exp_dir", "experiments/moving_mnist_state"))

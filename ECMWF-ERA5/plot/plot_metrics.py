...
def resolve_log_dir(log_dir: str | Path | None = None) -> Path:
    ...
    Default:
        project_root / experiments / era5_land_chengyu / logs
    """
    if log_dir is None:
        return get_project_root() / "experiments" / "era5_land_chengyu" / "logs"
...
def plot_image_prior_metrics(
    ...
    plot_pair(
        ...
        train_key="train_img_mse_norm",
        val_key="val_img_mse_norm",
    ...
    plot_pair(
        ax=axes[1],
        history=image_history,
        train_key="train_img_mae_norm",
        val_key="val_img_mae_norm",
...
def plot_num_prior_metrics(
    ...
    plot_pair(
        ax=axes[0],
        history=num_history,
        train_key="train_num_mse_norm",
        val_key="val_num_mse_norm",
        title="Numerical prior MSE (norm)",
        ylabel="MSE",
    )
    ...
    plot_pair(
        ax=axes[1],
        history=num_history,
        train_key="train_num_mae_norm",
        val_key="val_num_mae_norm",
        title="Numerical prior MAE (norm)",
        ylabel="MAE",
    )
...
def plot_gemininet_task_metrics(
    ...
    plot_pair(
        ...
        train_key="train_num_mse_norm",
        val_key="val_num_mse_norm",
        title="GeminiNet numerical MSE (norm)",
        ylabel="MSE",
    )
    ...
    plot_pair(
        ...
        train_key="train_num_mae_norm",
        val_key="val_num_mae_norm",
        title="GeminiNet numerical MAE (norm)",
        ylabel="MAE",
    )
...
def main(
    ...
    PNG output:
        project_root / experiments / era5_land_chengyu / logs / overview_plots
    """
